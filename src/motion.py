...
def datagenerators_cvpr2018_gen(gen, atlas_vol_bs, batch_size=1):
...
def datagenerators_example_gen(vol_names, batch_size=1, return_segs=False, seg_dir=None, np_var='vol_data'):
    """
    generate examples
...
def train(data_dir,
    ...
    train_vol_names = [ "%s/dynamic.%04d.nii.gz" % (data_dir,idfile) for idfile in range(32)] 
    ...
    train_example_gen = datagenerators_example_gen(train_vol_names, batch_size=batch_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--atlas_file", type=str,
                        dest="atlas_file", default='/rsrch1/ip/dtfuentes/github/ctperfusion/Processed/0004/dynamic.0033.nii.gz',
                        help="fixed image")
